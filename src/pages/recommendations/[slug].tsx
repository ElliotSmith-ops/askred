...
export default function RecommendationPage() {
  ...
  const [query, setQuery] = useState(readableQuery);
  ...
  const handleSearch = useCallback(async (inputQuery?: string) => {
    ...
    const delayTimer = setTimeout(() => setShowDelayNotice(true), 1200);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Reddit recommends. We link. You buy. Discover top-rated products backed by real Reddit threads for ${readableQuery}.`} />
      ...
      <main className="min-h-screen bg-gray-100 p-4 flex flex-col items-center">
        ...
        <button
          onClick={() => {
            ...
            gaEvent({ action: "bookmark_click", category: "engagement", label: "bookmark_this_page" });
          }}
