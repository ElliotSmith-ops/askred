    ...
    return (
      <main className="max-w-2xl mx-auto p-6 text-white">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>Clicks on Amazon links (via affiliate tracking)</li>
          <li>Basic site analytics (e.g., page views, referrers)</li>
        </ul>
        ...
        <p>We may update this Privacy Policy. Continued use of the site indicates acceptance of any changes.</p>
      </main>
    );
  }
